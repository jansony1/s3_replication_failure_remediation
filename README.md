...
aws cloudformation create-stack \
  ...
  --parameters \
      ...
      ParameterKey=SourceBucket,ParameterValue=[YourSourceBucket] \
...
* YourSourceBucket (optional): The source bucket to monitor. If provided, the replication-failure event notification is wired onto this bucket automatically by the stack. Leave it out (or pass an empty value) to keep the manual multi-bucket mode described below.
